...
<?php if ( comments_open() ) :// Comment Form ?>
	...
	<div id="respond">
		<h2><?php comment_form_title( __('Leave a Reply','striking_front'), __('Leave a Reply to %s','striking_front') ); ?></h2>
...
<?php else : ?>	
			...
			<p><input type="text" name="author" class="textfield" id="author" value="<?php echo $comment_author; ?>" size="22" tabindex="1"  />
			<label for="author"><?php _e('Name','striking_front');  if ($req) echo " *"; ?></label></p>
	
			<p><input type="text" name="email" class="textfield" id="email" value="<?php echo $comment_author_email; ?>" size="22" tabindex="2" />
			<label for="email"><?php _e('Email','striking_front');  if ($req) echo " *"; ?></label></p>
	
			<p><input type="text" name="url" class="textfield" id="url" value="<?php echo $comment_author_url; ?>" size="22" tabindex="3" />
			<label for="url"><?php _e('Website','striking_front'); ?></label></p>
	
<?php endif; ?>
			<p><textarea class="textarea" name="comment" id="comment"></textarea></p>
			<p><a class="l-submit" href="#" onclick="jQuery('#commentform').submit();return false;"><span><?php _e('Post Comment','striking_front');?></span></a><?php comment_id_fields(); ?></p>
