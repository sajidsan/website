...
$meta_boxes[] = array(
	...
	'fields' => array(
		array(
			...
			'std' => 'y',
			'desc' => 'If yes is selected, when viewed, this page/post will show just the default background image set in the theme options panel. If selected no, images uploaded below will be used.'
		),
		array(
			'name' => 'Background Images',
			'desc' => 'Upload the images you want to use for the background slider. You can upload as many as you want. (1 required unless you selected "Yes" above)',
			'id' => $prefix . 'bg_image',
