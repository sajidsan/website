...
class recentwidget extends WP_Widget {
    ...
    function recentWidget() {
        parent::WP_Widget(false, $name = 'Photorific - Recent Posts');	
    }
...
<?php  while ($r->have_posts()) : $r->the_post(); ?>
			...
			<div class="post_extra_info">
				<span class="thumbnail_list_title"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php echo esc_attr(get_the_title() ? get_the_title() : get_the_ID()); ?>"><?php if ( get_the_title() ) the_title(); else the_ID(); ?></a></span><br />
...
class popularwidget extends WP_Widget {
    ...
    function popularWidget() {
        parent::WP_Widget(false, $name = 'Photorific - Popular Posts');	
    }
...
class flickrwidget extends WP_Widget {
	function flickrWidget() {
		parent::WP_Widget(false, $name = 'Photorific - Flickr Widget');
	}
